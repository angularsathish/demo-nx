...
@Component({
  ...
  selector: 'demo-nx-right-sidebar',
  ...
  implements OnInit, AfterViewInit
{
  ...
  ngAfterViewInit() {
    ...
    if (localStorage.getItem('choose_skin')) {
      const chooseSki: any = localStorage.getItem('choose_skin');
      this.renderer.addClass(this.document.body, chooseSki);
      const chooseSkinAct: any = localStorage.getItem('choose_skin_active');
      this.selectedBgColor = chooseSkinAct;
    } else {
  ...
  lightThemeBtnClick() {
    ...
    if (localStorage.getItem('choose_skin')) {
      const chooseSki: any = localStorage.getItem('choose_skin');
      this.renderer.removeClass(this.document.body, chooseSki);
    } else {
  ...
  darkThemeBtnClick() {
    ...
    this.renderer.removeClass(this.document.body, 'logo-white');
    if (localStorage.getItem('choose_skin')) {
      const chosSki: any = localStorage.getItem('choose_skin');
      this.renderer.removeClass(this.document.body, chosSki);
    } else {
      this.renderer.removeClass(
        this.document.body,
        'theme-' + this.config.layout.theme_color
