...
@Component({
  selector: 'demo-nx-lookup-parent',
  templateUrl: './lookup-parent.component.html',
  styleUrls: ['./lookup-parent.component.scss'],
})
export class LookupParentComponent implements OnInit {
  columns = [
